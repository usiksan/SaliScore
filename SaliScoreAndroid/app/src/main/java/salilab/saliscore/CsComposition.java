...
public class CsComposition {
  private CsCompositionHeader mHeader;
  private String              mComposer;
  private String              mLyricist;

  private Integer             mLineStartOffset;        //!< Offset of line start in tick
  private Integer             mTickPerPart;            //!< Part duration in tick
  private Integer             mPartPerTakt;            //!< Part count per takt

  private Integer             mStepChord;
  private Integer             mStepNote;
  private Integer             mStepLyric;

  private QList<CsDefinition> mRemarkList;             //!< List of remark parts. Each part may be in different language
  private QList<CsDefinition> mChordList;              //!< List of chord parts. Each part may be for different accompanement or difficulties
  private QList<CsDefinition> mNoteList;               //!< List of note parts. Each part may be for different instrument or difficulties
  private QList<CsDefinition> mTranslationList;        //!< List of translation parts. Each part is translation of lyric to single language
